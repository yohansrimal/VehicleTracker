...
const Tracking = ({navigation}) => {
  ...
  const [trailerPhoto, setTrailerPhoto] = useState('');
  ...
  const filter = value => {
    ...
    const filteredCars = vehicleNoList.filter(vehicle =>
      vehicle.car_vin.toLowerCase().includes(lowerCased),
    );
    ...
    return (
      <View flexDirection="column">
        <View
          ...
          <Text style={{color: 'white', fontSize: 23}}>ඉදිරිපස අංක තහඩුව</Text>
          <View
            style={{
              marginTop: 30,
              width: 200,
            ...
            <TouchableOpacity onPress={() => TakePhto()}>
              <Image
                style={{
                  resizeMode: 'contain',
                  width: '100%',
    ...
    return (
      <View flexDirection="column">
        <View
          ...
          <Text style={{color: 'white', fontSize: 23}}>මීටර් කියවීම</Text>
          <View
            style={{
              marginTop: 30,
              width: 200,
